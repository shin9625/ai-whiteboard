    ...
    <header className="glass-panel sticky top-2 z-30 mx-2 sm:mx-4 my-2 sm:my-3 rounded-2xl px-3 sm:px-4 py-2 sm:py-2.5 flex items-center justify-between gap-2 shadow-md border border-white/60 dark:border-slate-700/60">
      ...
      <div className="hidden lg:flex items-center gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium rounded-xl text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 border border-indigo-200/60 dark:border-indigo-800/60 transition-colors"
          title="Gemini 自律エージェント & 利用状況"
        >
          <Bot className="w-3.5 h-3.5" />
          <span>Gemini利用状況</span>
          {todayUsageRequests !== undefined && (
            ...
            <>
              ...
              <div className="absolute right-0 mt-2 w-52 rounded-2xl glass-panel shadow-2xl border border-white/80 dark:border-slate-700 py-2 z-50 text-xs space-y-1">
                ...
                <button
                  ...
                  className="w-full px-3 py-2 text-left flex items-center justify-between hover:bg-slate-100 dark:hover:bg-slate-800 text-indigo-600 dark:text-indigo-400"
                >
